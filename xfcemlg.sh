...
sudo apt install firefox-esr vlc fonts-font-awesome git exa zoxide  linux-headers-amd64 firmware-iwlwifi firmware-misc-nonfree libreoffice fonts-noto-extra fonts-noto-color-emoji i3-wm
