...
alias ~="z ~"            # Go to home directory
alias home="z ~"         # Shortcut to home
alias dl="z ~/Downloads" # Jump to Downloads
alias dt="z ~/Desktop"   # Jump to Desktop
alias poweroff="sudo poweroff"    # Shutdown system
alias reboot="sudo reboot"        # Reboot system
alias cd="z"        # Use `z` instead of `cd`
alias apt="nala install "    # Use Nala Instead of Apt
